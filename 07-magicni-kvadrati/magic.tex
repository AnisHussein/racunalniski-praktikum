...
% - v okolju `center' uporabite ukaz  ``
...
Magični kvadrat v tabeli \ref{table:loshu} je normalen.
...
Magični kvadrat v litografiji Melancholia I (glej sliko \ref{durer}
...
(glej sliko \ref{sagrada} za fotografijo) vsebuje magični kvadrat reda 4.
% sklic: fig:sagrada
...
\begin{table}[ht]
   ...
   \begin{tabular}{lcccccc}\toprule
      ...
      red & 1 & 2 & 3 & 4 & 5 & 6 \\
      število kvadratov& 1 & 0 & 1 & 880 & 275305224 & $(1{,}7745 \pm 0{,}0016)^1019$ \\\bottomrule
      \end{tabular}
\end{table}
...
V tabelah \ref{table:mag5}, \ref{mag6} in \ref{mag9} so prikazani
...
% - oznaka: table:mag6
\begin{magic}{6}{Magični kvadrat reda 6}{mag6}
...
% - oznaka: table:mag9
\begin{magic}{9}{Magični kvadrat reda 9}{mag9}
